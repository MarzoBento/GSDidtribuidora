...
{
    public partial class ConsDocFornecedor : Form
    {
        public ConsDocFornecedor()
        {
            InitializeComponent();
        }
        ...
        private void carregarGrid()
        {
            ...
            {
                string strConn = "Select Fornecedor.idfornecedor as Codigo, Fornecedor.nome as Fornecedor" +
                " from Fornecedor, DocFornecedor Where DocFornecedor.idfornecedor = Fornecedor.idfornecedor AND nome  Like'" + txtpesquisa.Text + "%' Order by nome";
        ...
        private void DtGConsulta_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ViewDocFornecedor frcont = new ViewDocFornecedor(this);
            frcont.Show();
            this.Close();
        }
