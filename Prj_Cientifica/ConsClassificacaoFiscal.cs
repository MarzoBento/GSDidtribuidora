...
{
    public partial class ConsClassificacaoFiscal : Form
    {
        public ConsClassificacaoFiscal()
        {
            InitializeComponent();
        }
        ...
        private void carregarGrid()
        {
            ...
            {
                string strConn = "Select idclassificacaofiscal as Codigo, nome as Classificacao_Fiscal" +
                " from ClassificacaoFiscal Where nome  Like'" + txtpesquisa.Text + "%' Order by nome";
            ...
            DtGConsulta.Columns.Add("Classificacao_Fiscal", "Classificacao_Fiscal");
            DtGConsulta.Columns[0].Width = 80;
            DtGConsulta.Columns[1].Width = 480;
            DtGConsulta.Columns[0].DataPropertyName = "Codigo";
            DtGConsulta.Columns[1].DataPropertyName = "Classificacao_Fiscal";
            DtGConsulta.Refresh();
        ...
        {
            codfiscal = Convert.ToInt32(DtGConsulta[0, e.RowIndex].Value.ToString());
            ViewClassificacaoFiscal frcont = new ViewClassificacaoFiscal(this);
            frcont.Show();
            this.Close();
        }
