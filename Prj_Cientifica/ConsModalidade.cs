...
namespace Prj_Cientifica
{
    public partial class ConsModalidade : Form
    {
        ...
        private void carregarGrid()
        {
            ...
            {
                string strConn = "Select idmodalidade as Codigo, nome as Modalidade" +
                " from Modalidade Where nome  Like'" + txtpesquisa.Text + "%' Order by nome";
        ...
        {
            codmod = Convert.ToInt32(DtGConsulta[0, e.RowIndex].Value.ToString());
            ViewModalidade frcont = new ViewModalidade(this);
            frcont.Show();
            this.Close();
        }
