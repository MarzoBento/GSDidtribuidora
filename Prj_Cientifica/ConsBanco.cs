...
{
    public partial class ConsBanco : Form
    {
        public ConsBanco()
        {
            InitializeComponent();
        ...
        private void carregarGrid()
        {
            ...
            {
                string strConn = "Select idbanco as Codigo, nome as Banco" +
                " from Banco Where nome  Like'" + txtpesquisa.Text + "%' Order by nome";
        ...
        {
            codbanco = Convert.ToInt32(DtGConsulta[0, e.RowIndex].Value.ToString());
            ViewBanco frcont = new ViewBanco(this);
            frcont.Show();
            this.Close();
        }
