...
{
    public partial class ConsTipoDocumento : Form
    {
        public ConsTipoDocumento()
        {
            InitializeComponent();
        }
        ...
        private void carregarGrid()
        {
            ...
            {
                string strConn = "Select idtipodocumento as Codigo, nome as Documento" +
                " from TipoDocumento Where nome  Like'" + txtpesquisa.Text + "%' Order by nome";
        ...
        {
            coddoc = Convert.ToInt32(DtGConsulta[0, e.RowIndex].Value.ToString());
            ViewTipoDocumento frcont = new ViewTipoDocumento(this);
            frcont.Show();
            this.Close();
        }
