...
{
    public partial class ConsFabricante : Form
    {
        public ConsFabricante()
        {
            InitializeComponent();
        }
        ...
        private void carregarGrid()
        {
            ...
            {
                string strConn = "Select idfabricante as Codigo, nome as Fabricante" +
                " from Fabricante Where nome  Like'" + txtpesquisa.Text + "%' Order by nome";
            ...
            DtGConsulta.Columns[1].Width = 515;
            DtGConsulta.Columns[0].DataPropertyName = "Codigo";
            DtGConsulta.Columns[1].DataPropertyName = "Fabricante";
            DtGConsulta.Refresh();
        ...
        {
            codfabricante = Convert.ToInt32(DtGConsulta[0, e.RowIndex].Value.ToString());
            ViewFabricante frcont = new ViewFabricante(this);
            frcont.Show();
            this.Close();
        }
