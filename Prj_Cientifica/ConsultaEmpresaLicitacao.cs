...
{
    public partial class ConsultaEmpresaLicitacao : Form
    {
        public ConsultaEmpresaLicitacao()
        {
            InitializeComponent();
        }

        public int codemplict;
        private void carregarGrid()
        {
            ...
            {
                string strConn = "Select idempresa as Codigo, nome as Empresa" +
                " from EmpresaLicitacao Where nome  Like'" + txtpesquisa.Text + "%' Order by nome";
            ...
            DtGConsulta.Columns[1].Width = 510;
        ...
        {
            codemplict = Convert.ToInt32(DtGConsulta[0, e.RowIndex].Value.ToString());
            ViewEmpresaLicitacao frcont = new ViewEmpresaLicitacao(this);
            frcont.Show();
            this.Close();
        }
