...
namespace Prj_Cientifica
{
    public partial class ConsUsuario : Form
    {
        ...
        private void carregarGrid()
        {
            ...
            {
                string strConn = "Select idusu as Codigo, nome as Usuario" +
                " from usuarios Where nome  Like'" + txtpesquisa.Text + "%' Order by nome";
        ...
        {
            codusuario = Convert.ToInt32(DtGConsulta[0, e.RowIndex].Value.ToString());
            ViewUsuarios frcont = new ViewUsuarios(this);
            frcont.Show();
            this.Close();
        }
