...
{
    public partial class ConsConcorrente : Form
    {
        public ConsConcorrente()
        {
            InitializeComponent();
        }


        public int codconcorrente;
        private void carregarGrid()
        {
            ...
            {
                string strConn = "Select idconcorrente as Codigo, nome as Concorrente" +
                " from Concorrente Where nome  Like'%" + txtpesquisa.Text + "%' Order by nome";
            ...
            DtGConsulta.Columns.Add("Concorrente", "Concorrente");
            DtGConsulta.Columns[0].Width = 80;
            DtGConsulta.Columns[1].Width = 535;
            DtGConsulta.Columns[0].DataPropertyName = "Codigo";
            DtGConsulta.Columns[1].DataPropertyName = "Concorrente";
            DtGConsulta.Refresh();
        ...
        {
            codconcorrente = Convert.ToInt32(DtGConsulta[0, e.RowIndex].Value.ToString());
            ViewConcorrentes frcont = new ViewConcorrentes(this);
            frcont.Show();
            this.Close();
        }
