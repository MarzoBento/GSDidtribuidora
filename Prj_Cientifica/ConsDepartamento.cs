...
{
    public partial class ConsDepartamento : Form
    {
        public ConsDepartamento()
        {
            InitializeComponent();
        }
        ...
        private void carregarGrid()
        {
            ...
            {
                string strConn = "Select iddepartamento as Codigo, nome as Departamento" +
                " from Departamento Where nome  Like'" + txtpesquisa.Text + "%' Order by nome";
        ...
        {
            coddepto = Convert.ToInt32(DtGConsulta[0, e.RowIndex].Value.ToString());
            ViewDepartamento frcont = new ViewDepartamento(this);
            frcont.Show();
            this.Close();
        }
